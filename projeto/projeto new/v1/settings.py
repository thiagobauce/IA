...
SECRET_KEY = "django-insecure-ewjqypu=60#1x@b^pa0gd_dp)ps*fa8zzxqvk90j3l87rj&2_^"
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'projeto new/media')
MEDIA_URL = "/media/"
